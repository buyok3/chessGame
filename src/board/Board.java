...
public class Board {
    ...
    public String toString() {
        ...
        for (int i = 0; i < BoardUtils.TILES_NUMBER; i++) {
            final String tileText = this.gameBoard.get(i).toString();
            builder.append(String.format("%3s", tileText));
            if ((i + 1) % BoardUtils.TILES_NUMBER_PER_ROW == 0){
                builder.append("\n");
            }
        }
    ...
    private static Collection<Piece> calculateAlivePieces(final List<Tile> gameBoard,
        ...
        final Collection<Piece> alivePieces = new ArrayList<>();
        ...
        return ImmutableList.copyOf(alivePieces);
    }
    ...
    private static List<Tile> createGameBoard(final Builder builder) {
        final Tile[] tiles = new Tile[BoardUtils.TILES_NUMBER];
